...
export HUNG_HOME
RC=0
for arm in stop_healthy stop_hung rewind_hung restart_busy restart_stalled boot_init_probe boot_hooks_probe boot_hooks_restart boot_stall_flag boot_stall_clears auto_restart_row; do
