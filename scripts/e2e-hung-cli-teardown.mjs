...
const ARMS = ['stop_hung', 'stop_healthy', 'rewind_hung', 'restart_stalled', 'restart_busy'];
...
sdk.__setQueryFactoryForTests(({ prompt }) => {
  ...
  return {
    async *[Symbol.asyncIterator]() {
      // The field shape: system/init lands (firstMessageSeen), then silence.
      yield INIT;
      await never();
    },
...
if (ARM === 'stop_hung' || ARM === 'stop_healthy') {
