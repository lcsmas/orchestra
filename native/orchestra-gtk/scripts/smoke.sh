...
# 7 mock workspace rows + the B3 toolbar/tabs, capture a screenshot, print PASS/FAIL.
#
...
check("7 mock workspace rows", sum(1 for n in names if str(n).startswith("ws-row-")) == 7)
