...
const api: OrchestraAPI = {
  ...
  getBusDivergence: () => ipcRenderer.invoke('bus:divergence'),
  ...
  listAccountBaseUrlIds: () => ipcRenderer.invoke('accounts:baseUrlIds'),
  saveAccountBaseUrl: (accountId, url) => ipcRenderer.invoke('accounts:saveBaseUrl', accountId, url),
  ...
  agentSdkStatus: (wsId) => ipcRenderer.invoke('agent:sdkStatus', wsId),
  agentSdkInterrupt: (wsId) => ipcRenderer.invoke('agent:sdkInterrupt', wsId),
  agentSdkQueueRemove: (wsId, id) => ipcRenderer.invoke('agent:sdkQueueRemove', wsId, id),
  agentSdkQueueEdit: (wsId, id, text) => ipcRenderer.invoke('agent:sdkQueueEdit', wsId, id, text),
  agentSdkQueueMove: (wsId, id, dir) => ipcRenderer.invoke('agent:sdkQueueMove', wsId, id, dir),
  agentSdkQueueCoalesce: (wsId, id, on) =>
    ipcRenderer.invoke('agent:sdkQueueCoalesce', wsId, id, on),
  agentSdkClear: (wsId) => ipcRenderer.invoke('agent:sdkClear', wsId),
  agentSdkRewind: (wsId, rewindId, prevRewindId) =>
  ...
  agentSdkSetRemoteControl: (wsId, enabled) =>
    ipcRenderer.invoke('agent:sdkSetRemoteControl', wsId, enabled),
  agentSdkMcpStatus: (wsId) => ipcRenderer.invoke('agent:sdkMcpStatus', wsId),
  agentSdkMcpRefresh: (wsId) => ipcRenderer.invoke('agent:sdkMcpRefresh', wsId),
  agentSdkMcpToggle: (wsId, serverName, enabled) =>
  ...
  modelDefaults: () => ipcRenderer.invoke('settings:modelDefaults'),
  setModelDefaults: (next) => ipcRenderer.invoke('settings:setModelDefaults', next),
